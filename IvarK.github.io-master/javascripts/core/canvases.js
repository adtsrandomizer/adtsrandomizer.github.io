    ...
    if (shiftDown && document.getElementById("eternitystore").style.display !== "none" && document.getElementById("timestudies").style.display !== "none") {
        for (i=0; i<all.length; i++) {
            ...
            if (document.getElementById(all[i]).className.split(" ")[1] !== undefined || all[i] > 220) {
                ...
                else if (tempName.includes("normaldimstudy")) name = "green"
                else if (tempName.includes("infdimstudy")) name = "orange"
                else if (tempName.includes("timedimstudy")) name = "purple"
                else if (tempName.includes("activestudy")) name = "left"
                else if (tempName.includes("passivestudy")) name = "middle"
                else if (tempName.includes("idlestudy")) name = "right"
