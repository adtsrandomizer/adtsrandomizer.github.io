...
function getTickSpeedMultiplier() {
  ...
  if (player.galaxies + player.replicanti.galaxies + player.dilation.freeGalaxies < 3) {
      ...
      if (player.effectiveStudies.includes(133)) galaxies += player.replicanti.galaxies/2
      if (player.effectiveStudies.includes(132)) galaxies += player.replicanti.galaxies*0.4
      if (player.effectiveStudies.includes(225)) galaxies += Math.floor(player.replicanti.amount.e / 1000)
      if (player.effectiveStudies.includes(226)) galaxies += Math.floor(player.replicanti.gal / 15)
      ...
      if (player.effectiveStudies.includes(212)) perGalaxy *= Math.min(Math.pow(player.timeShards.max(2).log2(), 0.005), 1.1)
      ...
      if (player.effectiveStudies.includes(212)) galaxies *= Math.min(Math.pow(player.timeShards.max(2).log2(), 0.005), 1.1)
      if (player.effectiveStudies.includes(232)) galaxies *= Math.pow(1+player.galaxies/1000, 0.2)
