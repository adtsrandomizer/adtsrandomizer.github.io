...
function canBuyStudy(name) {
  ...
  switch(row) {
      ...
      } else if (!player.effectiveStudies.includes(201)) {
...
function studiesUntil(id) {
  ...
  for (var i = 1; i < row; i++) {
      ...
      if ((i > 6 && i < 11) && player.effectiveStudies.includes(201)) buyTimeStudy(i * 10 + secondPath, studyCosts[all.indexOf(i * 10 + secondPath)], 0);
