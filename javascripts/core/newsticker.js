...
["Randomizer, randomizer, who's the unluckiest on Earth?", true, "a29"], ["Welcome everyone to the Cursed Randomizer, episode 251. Last time we beat P3 and we're now getting the last bosses for P4. For new subscribers: We're on SS, going for 112%, Split Items is enabled, Clone Important Items is disabled. Swim is randomized but we found it a hundred episodes ago. We also want to beat P5 so we're gonna real quick get all directions for Split Nai- Wait, what do you mean wrong game?", true, "a30"], ["BOO!", true, "a31"], ["You ate for too long. -hevipelle", true, "a32"], ["I hate myself. -Boo-chan", true, "a33"],
...
["Did you use an autoclicker for that? Or is the Randomizer screwing with you?", "player.effectiveStudies.includes(131) && player.thisInfinityTime <= 600 && player.replicanti.galaxies >= 50", "c5"],
["Timing is key.", "player.thisEternity < 1", "c6"],
["If you want to farm infinitied, why don't you just get the time study? Oh, wait...", "!player.effectiveStudies.includes(32) && player.infinitied > 72000 * 168", "c7"],
...
["Farm more eternities.", "player.eternities > 2000000", "c11"],
